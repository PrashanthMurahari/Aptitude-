    ...
    if given_direction == "opposite":
        if speed_condition == "kmph" and length_of_trains_condition == "km":
            ...
            if total_time_taken_to_cross_each_other > 60:
                print("Total Time Taken To Cross Each Other = " + str(round(total_time_taken_to_cross_each_other // 60)) + " Min " + str(round(total_time_taken_to_cross_each_other % 60)) + " secs")
            else:
...
# Finding Speeds For Two trains and For one sinlge train
    ...
    if need_the_speed_in == "kmph":
        ...
        print("Total Length Of Two Trains = Length Of Train-A + Length Of Train-B " + "\n" + "Total Length Of Two Trains = " + str(length_of_train_A) + " + " + str(length_of_train_B))
        print("Total Speed Of Two Trains = Total Length Of Two Trains/Time Taken To Cross Each Other*(18/5)" + "\n" + "Total Speed Of Two Train = " + str(round(total_speed_of_two_trains,2)))
    ...
    if given_direction == "opposite":
        ...
        if speed_of_one_train_given_in == "kmph" and need_the_speed_in == "kmph":
            ...
            print("Length Of Train-A = " + str(length_of_train_A) + "\n" + "Length Of Train-B = " + str(length_of_train_B) + "\n" + "Total Length of two trains = " + str(total_length_of_two_trains))
            print("Time Taken To Cross Each other = " + str(time_taken_to_cross))
            print("Total Speed Of Two trains = (Total Length of two trains/Time Taken To Cross Each other) *(18/5)   ->(To convert into kmph we use 18/5)" + "\n" + "Total Speed Of Two trains = (" + str(total_length_of_two_trains) + "/" + str(time_taken_to_cross) + ")*(18/5)")
            print("Speed Of Another Train = Total Speed Of Two trains - Speed of One train" + "\n" + "Speed Of Another Train = " + str(total_speed_of_two_trains) + " - " + str(speed_of_one_train))
            ...
            print("Length Of Train-A = " + str(length_of_train_A) + "\n" + "Length Of Train-B = " + str(length_of_train_B) + "\n" + "Total Length of two trains = " + str(total_length_of_two_trains))
            print("Time Taken To Cross Each other = " + str(time_taken_to_cross))
            print("Total Speed Of Two trains = (Total Length of two trains/Time Taken To Cross Each other) " + "\n" + "Total Speed Of Two trains = (" + str(total_length_of_two_trains) + "/" + str(time_taken_to_cross) + ")")
            print("Speed Of Another Train = Total Speed Of Two trains - Speed of One train *(18/5) " + "\n" + "Speed Of Another Train = (" + str(total_speed_of_two_trains) + " - " + str(speed_of_one_train) + ")*(18/5)   ->(To convert into kmph we use 18/5)")
            print("Speed Of Another Train " + str(round(speed_of_another_train, 1)) + " kmph")
            ...
            print("Time Taken To Cross Each other = " + str(time_taken_to_cross))
            print("Total Speed Of Two trains = (Total Length of two trains/Time Taken To Cross Each other) *(18/5)   ->(To convert into kmph we use 18/5)" + "\n" + "Total Speed Of Two trains = (" + str(total_length_of_two_trains) + "/" + str(time_taken_to_cross) + ")")
            print("Speed Of Another Train = Total Speed Of Two trains - Speed of One train" + "\n" + "Speed Of Another Train = " + str(total_speed_of_two_trains) + " - (" + str(speed_of_one_train) + "*18/5")
        ...
        if speed_of_one_train_given_in == "kmph" and need_the_speed_in == "kmph":
            ...
            print("Length Of Train-A = " + str(length_of_train_A) + "\n" + "Length Of Train-B = " + str(length_of_train_B) + "\n" + "Total Length of two trains = " + str(total_length_of_two_trains))
            print("Time Taken To Cross Each other = " + str(time_taken_to_cross))
            print("Total Speed Of Two trains = (Total Length of two trains/Time Taken To Cross Each other) *(18/5)   ->(To convert into kmph we use 18/5)" + "\n" + "Total Speed Of Two trains = (" + str(total_length_of_two_trains) + "/" + str(time_taken_to_cross) + ")*(18/5)   ->(To convert into kmph we use 18/5)")
            print("Speed Of Another Train = Total Speed Of Two trains + Speed of One train" + "\n" + "Speed Of Another Train = " + str(total_speed_of_two_trains) + " + " + str(speed_of_one_train))
            print("Speed Of Another Train " + str(round(speed_of_another_train, 1)) + " kmph")
        elif speed_of_one_train_given_in == "metres" and need_the_speed_in == "kmph":
            total_speed_of_two_trains = total_length_of_two_trains / time_taken_to_cross
            ...
            print("Length Of Train-A = " + str(length_of_train_A) + "\n" + "Length Of Train-B = " + str(length_of_train_B) + "\n" + "Total Length of two trains = " + str(total_length_of_two_trains))
            print("Time Taken To Cross Each other = " + str(time_taken_to_cross))
            print("Total Speed Of Two trains = (Total Length of two trains/Time Taken To Cross Each other)    ->(To convert into kmph we use 18/5)" + "\n" + "Total Speed Of Two trains = (" + str(total_length_of_two_trains) + "/" + str(time_taken_to_cross) + ")*(18/5)")
            print("Speed Of Another Train = Total Speed Of Two trains + Speed of One train" + "\n" + "Speed Of Another Train = " + str(total_speed_of_two_trains) + " + (" + str(speed_of_one_train) + "*(18/5))   ->(To convert into kmph we use 18/5)")
            print("Speed Of Another Train " + str(round(speed_of_another_train, 1)) + " metres")
        elif speed_of_one_train_given_in == "metres" and need_the_speed_in == "metres":
            total_speed_of_two_trains = total_length_of_two_trains / time_taken_to_cross
...
# Finding Lengths Of Two Trains and Also For One Train
    ...
    if given_direction == "opposite":
        if speed_condition == "kmph":
            ...
            print("Speed Of Train A = " + str(speed_of_train_A) + "\n" + "Speed Of Train B = " + str(speed_of_train_B) + "\n" + "Time Taken To Cross Each Other = " + str(time_taken_to_cross) + "\n" + "Total Speed Of Two Trains = Speed Of Train A + Speed Of Train B" + "\n" + "Total Speed Of Two Trains = " + (str(speed_of_train_A) + "  + " + str(speed_of_train_B)) + "")
            print("Length Of Two Trains = Total Speed Of Two Trains * Time Taken To Cross Each Other " + "\n" + "Length Of Two Trains = " + str(round(total_speed_of_two_trains, 2)) + " * " + str(time_taken_to_cross) + "\n" + "Length Of Two Trains = " + str(round(lengths_of_two_trains, 2)) + "\n" + "Length Of One Train = " + str(round(lengths_of_two_trains / 2, 2)))
...
# Finding Time For Crossing A bridge Or A Platform Or A Tunnel
    ...
    if need_to_find == "speed":
        lengths_of_train_and_bridge = list(map(float, input("Enter the lengths of train and given tunnel or bridge or platform:").split()))
        ...
        if speed_condition == "kmph":
            ...
            print("Time Taken To Cross The " + given_situation + " = " + str(time_taken_to_cross) + " secs" + "\n" + "Length Of Train = " + str(length_of_train) + "\n" + "Length Of The " + given_situation + " = " + str(length_of_the_bridge))
            print("Total length = " + str(total_length_of_train_and_bridge))
            print("Speed Of The Train = (" + str(total_length_of_train_and_bridge) + "/" + str(time_taken_to_cross) + ")*18/5" + "\n" + "Speed Of The Train = " + str(round(speed_of_the_train, 2)) + "kmph")
        elif speed_condition == "metres":
        ...
        if speed_condition == "kmph":
            ...
            print("Speed Of the Train = " + str(speed_of_the_train) + "\n" + "Length Of The Train = " + str(length_of_train) + "\n" + "Length Of The " + given_situation + " = " + str(length_of_the_bridge))
            print("Total Length = " + str(total_length_of_train_and_bridge))
            print("Time Taken To Cross " + given_situation + " = " + str(total_length_of_train_and_bridge) + "/(" + (str(speed_of_the_train)) + ")*5/18")
            ...
            print("Speed Of the Train = " + str(speed_of_the_train) + "\n" + "Length Of The Train = " + str(length_of_train) + "\n" + "Length Of The " + given_situation + " = " + str(length_of_the_bridge))
            print("Total Length = " + str(total_length_of_train_and_bridge))
            print("Time Taken To Cross " + given_situation + " = " + str(total_length_of_train_and_bridge) + "/" + (str(speed_of_the_train)))
            print("Time Taken To Cross " + given_situation + " = " + str(round(time_taken_to_cross, 2)))
        else:
            print("Please enter valid input")
        ...
        if speed_condition == "kmph":
            ...
            print("Speed Of the Train = " + str(speed_of_the_train) + "\n" + "Time Taken To Cross = " + str(time_taken_to_cross))
            print("Total Length = (Speed Of the Train*5/18) * Time Taken To Cross" + "\n" + "Total Length = " + str(round(total_length_of_train_and_bridge, 2)))
        ...
        if speed_condition == "kmph":
            ...
            print("Speed Of the Train = " + str(speed_of_the_train) + "\n" + "Time Taken To Cross = " + str(time_taken_to_cross) + "\n" + "Length Of the " + given_situation + " = " + str(length_of_the_bridge))
            print("Length Of the Train = ((Speed Of the Train*5/18) * Time Taken To Cross) - Length Of The " + given_situation + "\n" + "Length of the Train = " + str(round(length_of_train, 2)))
        elif speed_condition == "metres":
            length_of_train = (time_taken_to_cross * speed_of_the_train) - length_of_the_bridge
            print("Speed Of the Train = " + str(speed_of_the_train) + "\n" + "Time Taken To Cross = " + str(time_taken_to_cross) + "\n" + "Length Of the " + given_situation + " = " + str(length_of_the_bridge))
            print("Length Of the Train = ((Speed Of the Train) * Time Taken To Cross) - Length Of The " + given_situation + "\n" + "Length of the Train = " + str(round(length_of_train, 2)))
        else:
            print("Please enter valid input")
        ...
        if speed_condition == "kmph":
            ...
            print("Length Of the " + given_situation + " = ((Speed Of the Train*5/18) * Time Taken To Cross) - Length Of The Train" + "\n" + "Length of the " + given_situation + " = ((Speed Of the Train) * Time Taken To Cross) - Length Of The Train  " + "\n" + "Length of The " + given_situation + " = " + str(round(length_of_bridge, 2)))
        elif speed_condition == "metres":
            length_of_the_bridge = (time_taken_to_cross * speed_of_the_train) - length_of_the_train
            print("Speed Of the Train = " + str(speed_of_the_train) + "\n" + "Time Taken To Cross = " + str(time_taken_to_cross) + "\n" + "Length Of the " + given_situation + " = " + str(length_of_the_train))
            print("Length Of the " + given_situation + " = ((Speed Of the Train) * Time Taken To Cross) - Length Of The Train" + "\n" + "Length of the " + given_situation + " = ((Speed Of the Train) * Time Taken To Cross) - Length Of The Train  " + "\n" + "Length of The " + given_situation + " = " + str(round(length_of_the_bridge, 2)))
        else:
            print("Please enter valid input")
    else:
        print("Please enter valid input")
