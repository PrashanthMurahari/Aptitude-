...
def calculating_speed_of_train(time_taken_to_cross_the_man, length_of_train, speed_of_man, speed_condition,given_direction):
    if given_direction == "opposite":
        if speed_condition == "kmph":
            speed_of_train = (length_of_train / time_taken_to_cross_the_man)*18/5 - (speed_of_man )
            print("Speed of man " + " = " + str(speed_of_man))
            print("Length of train = " + str(length_of_train))
            print("Time taken to cross "  + " = " + str(time_taken_to_cross_the_man))
            print("Speed of train = (" + str(length_of_train) + " / " + str(time_taken_to_cross_the_man) + ")*18/5 - " + str(speed_of_man) )
...
def calculating_speed_of_man(time_taken_to_cross_the_man, length_of_train, speed_of_train, speed_condition,given_direction):
    if given_direction == "opposite":
        if speed_condition == "kmph":
...
if need_to_find == "length of train":
    ...
    calculating_speed_of_train(time_taken_to_cross_the_man, length_of_train, speed_of_man, speed_condition,given_direction)
elif need_to_find == "speed of man":
   time_taken_to_cross_the_man = float(input("Enter time taken to cross the man:"))
   length_of_train = float(input("Enter the length of train:"))
   speed_of_train = float(input("Enter the speed of the train:"))
   calculating_speed_of_man(time_taken_to_cross_the_man, length_of_train, speed_of_train, speed_condition,given_direction)
else:
